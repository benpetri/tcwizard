function list_path=buttondown(list2,list_path);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% [...]=buttondown(...)
% Move down selected phase in the phase list for the Wizard mode
%
...
if position < (length(list_path))
    tmpsel=list_path(position);
    tmpdown=list_path(position+1);
    list_path(position+1)=tmpsel;
    list_path(position)=tmpdown;
